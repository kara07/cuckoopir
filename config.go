...
const (
	...
	stashSize             = 16   // Size of stash (see Kirsch, Adam, Michael Mitzenmacher, and Udi Wieder. "More robust hashing: Cuckoo hashing with a stash." SIAM Journal on Computing 39.4 (2009): 1543-1561.)
)
...
const (
	...
	DefaultLogSize = 6 + bshift	// minimum number of buckets
)
